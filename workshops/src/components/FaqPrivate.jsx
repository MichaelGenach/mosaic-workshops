    ...
    workshops: [
      ...
      },
      {
        ...
        questions: [
          ...
          { q: "אפשר לקיים את הסדנה בבית שלי או בעסק שלי?", a: "בהחלט! אנחנו מגיעים עם כל הציוד לבית פרטי, למשרד או לכל מיקום לבחירתכם ברחבי הארץ – לא רק לגלריה בנמל קיסריה" },
    ...
    workshops: [
      ...
      },
      {
        ...
        questions: [
          ...
          { q: "Can the workshop be held at my home or business?", a: "Absolutely! We bring all the equipment to a private home, office, or any location of your choice across the country – not just to our gallery in Caesarea port" },
