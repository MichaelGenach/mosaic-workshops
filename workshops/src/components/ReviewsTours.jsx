...
export default function Reviews({ language, languageSettings }) {
    ...
    const reviewsHe = [
        ...
        {
            name: "צוות מורים",
            review: "כקבוצת מורים בת 12 משתתפים, חיפשנו דרך מיוחדת ומעשירה לסיים את שנת הלימודים – ומצאנו בדיוק את מה שחיפשנו עם מייקל! מייקל תכנן עבורנו מסלול מותאם אישית, תוך הקפדה על תוכן מרתק, מקומות מוצלים ונעימים – גם ביום קיץ חם במיוחד. נהנינו מכל רגע. מומלץ לכל קבוצה שמחפשת חוויה איכותית ומעשירה.",
            rating: 5
        },
        {
            name: "חיים",
